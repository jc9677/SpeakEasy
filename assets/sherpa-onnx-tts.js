...
// Expose a browser global SherpaOnnxTts with a create() method
if (typeof window !== 'undefined') {
  window.SherpaOnnxTts = {
    create: async function(config) {
      // Wait for the WASM module to be ready
      if (typeof Module === 'undefined' || typeof Module.onRuntimeInitialized === 'undefined') {
        throw new Error('sherpa-onnx-wasm-main-tts.js must be loaded before this script.');
      }
      ...
      return new Promise(resolve => {
        Module.onRuntimeInitialized = function() {
          resolve(createOfflineTts(Module, config));
        };
      });
    }
  };
